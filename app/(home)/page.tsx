...
export default function Page() {
  ...
  return (
    <>
      ...
      <Container className="space-y-3">
        <h2 className="text-3xl font-bold tracking-tighter">NSB란?</h2>
      ...
      <div className="grid w-full grid-cols-1 lg:grid-cols-3 items-stretch justify-center gap-4 lg:gap-6">
        <Card>
          ...
          <CardContent className="flex flex-col items-center">
            <h3 className="text-xl font-bold tracking-tighter">Cloud</h3>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col items-center">
            <h3 className="text-xl font-bold tracking-tighter">네트워킹</h3>
          </CardContent>
          <CardFooter className="text-center flex justify-center">
      ...
      <Container className="space-y-3">
        <h2 className="text-3xl font-bold tracking-tighter">지난활동들</h2>
